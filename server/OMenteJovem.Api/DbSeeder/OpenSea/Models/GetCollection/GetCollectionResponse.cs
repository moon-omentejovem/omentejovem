...
public record GetCollectionResponse
{
    ...
    [JsonProperty("safelist_status")]
    public object SafelistStatus { get; init; }
    ...
    [JsonProperty("fees")]
    public List<FeeResponse> Fees { get; init; }

    [JsonProperty("required_zone")]
    public string RequiredZone { get; init; }

    [JsonProperty("rarity")]
    public RarityResponse Rarity { get; init; }

    [JsonProperty("payment_tokens")]
    public List<PaymentTokenResponse> PaymentTokens { get; init; }
