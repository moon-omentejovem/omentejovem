...
const HardCodedBio = () => (
  <div className="max-w-[65ch] text-base">
    ...
    <p>
      ...
      12, many preemptively dismissed his aspirations as impractical, cautioning
      him about the hardships. “They said it would be extremely difficult and I
      might struggle for basic needs,” he notes. Consequently, Machado shelved
      this dream, not giving it much consideration. “I went on with my life,
    ...
    <p>
      ...
      and rapper friends. “I made cover arts and lyric videos for their social
    ...
    <p>
      ...
      creative freedom he had. “I was designing for a song, for a person. I had
      ideas I liked, but they needed approval from others,” he recalls. Machado
    ...
    <p>
      ...
      first-person shooter (FPS) games, Machado easily grasped the concept of
      digital assets. “Etienne gave me some Ethereum to mint my first piece, and
      to my surprise, it sold for 0.4 ETH the next morning. That was equivalent
      to what I’d earn in a month, working tirelessly around the clock, and only
    ...
    <p>
      ...
      artists. He also began refining his artistic vision and aesthetics while
      improving his English skills. “I realized I needed to devote myself
    ...
    <p>
      ...
      made a world of difference.” Previously, Machado relied on his brother’s
      computer, situated in the family’s living room. “Working there was
      challenging; I had to use it at night or early dawn when it was available
      and quieter, away from the distractions of family and visitors.” Now, he
    ...
    <p>
      ...
      had changed,” he states. “But I also knew that I had to maintain momentum
      with my creativity and had to continue enhancing my aesthetic and vision,”
      he reflects. Determined not to squander this opportunity, Machado’s strong
    ...
    <p>
      ...
      notion of being ‘an artist’ led him to believe he needed a distinct,
      recognizable style. “My early artworks were very structured. I didn’t
      think I could create something solely for its aesthetic value. I aimed for
      linearity and specific forms,” he explains. However, this approach quickly
      became burdensome, stifling his creativity and joy. “I returned to the
      method from my teenage years in class: drawing random lines, allowing
      myself freedom, and then discovering beauty in it. That reignited my
    ...
    <p>
      ...
      “During a long, heavily under influenced, laughter-filled evening with
      friends, we realized how our young minds were guiding us that night,” he
      recounts. “We made spontaneous decisions, unshackled by rules or fear of
      the unknown. ‘Omentejovem,’ or ‘O Mente Jovem’ in Portuguese, translates
      to ‘The Young Mind.’ This resonated with me instantly and serves as a
    ...
    <p>
      ...
      often, it symbolizes something significant to me, capturing a specific
      emotion or event.” His work acts as a visual diary, drawing inspiration
      ...
      is a direct reference to a moment of self-realization. “That day, I felt
    ...
    <p>
      ...
      therefore also holds significant meaning for omentejovem. He shares: “I
      created it when I experienced a powerful energy. It felt like everything
      aligned, and I knew I had the capability to transform my life, as well as
      the lives of my family and friends,{' '}
      <span>
        as long as I just kept having attention to creating: combining my
        passion and putting in the effort for it.
      </span>
      ”
    </p>
    <br />
    ...
    <p>
      ...
      Machado is keen on expanding his color range to add more depth to his
      work. “I admire artists like Miro, whom I discovered quite late, and have
      always looked up to Kandinsky and Picasso. Their innovations have
    ...
    <p>
      ...
      representational: a person, an animal, an object, emerging from random
      lines. But at times, I’m not aiming to depict anything specific; I’m
      intrigued to see how my audience interprets various shapes,” he explains.
      “It’s always a blend for me. Sometimes, I want the origin of a piece to be
      clear, so I give it a descriptive title just like{' '}
      <em>The Day I Found out I Can Do Anything</em>,{' '}
      <em>The Day I Felt God</em>{' '}
      <span>
        and also <em>The Day I met you</em> for example
      </span>
      . Other times, I prefer everything to be open to interpretation, allowing
      abstraction to take the lead. I let viewers perceive the piece through
      their own experiences, beliefs, and opinions. It’s particularly rewarding
    ...
    <p>
      ...
      thinking about the possibilities of making art. At dawn I found myself
      staring at and contemplating the concept of the moon, since I still worked
    ...
    <p>
      ...
      wakefulness and dream. “My mind wandered off, seeing a desired future for
    ...
    <p>
      ...
      creation and reflection. “I felt I had my own career and my own life in my
    ...
    <p>
      ...
      omentejovem used and the ‘vehicle’ propelling him forward in his artistic
      pursuit. This resonates with the artist’s account of working hard –
      through odd hours – and the determination to manifest his aspirations
    ...
    <p>
      ...
      trajectory. They suggest awareness, a conscious steering of one’s destiny,
      and a vigilant reflection on feedback and self-evaluation. “I believe my
      rapid progress in the space stems from not limiting myself, but being
      mindful of my actions and actively listening to others at the same time.”
    ...
    <p>
      ...
      charting a path to the future they envision. In its entirety, the artwork
      is a visual articulation of the omentejovem’s ethos: to dream without
      bounds, to labor with intent, and to shape reality with the tools of his
      craft. The narrative woven through <em>Creative Workaholic</em> is one of
    ...
    <p>
      ...
      recurring motifs of ‘The Moon’ and ‘The Dot’, which the artist has imbued
      with philosophical significance, and which appear in many of his works.
      The moon, which can be seen as a symbol of the unconscious and a guide
      through the darkness (both as opposed to the sun), is rendered with a
      contemplative and huge presence (big and sketch-like in black and then
      very small but bright and with clear lines inside that bigger half-moon
      shape). The lunar element speaks to the cycles of creativity and
    ...
    <p>
      ...
      vast canvas of existence. It can be found in multiple places in this
      piece, but most significantly on the right side, ‘alone’ in the off-white.
      ‘The Dot’ serves as a reminder to maintain one’s core in a (fast-paced)
      changing world, like a nexus of self amidst the swirling cosmos of
      potential and distraction.
      <br />
      The interplay between the overarching presence of ‘The Moon’ and the
      grounding ‘The Dot’ creates a dichotomy within the artwork, symbolizing
      the balance between the vastness of the cosmos and the intimacy of
      individual existence. The dynamic between the two can be interpreted as a
    ...
    <p>
      ...
      They invite the viewer to contemplate their own place in the universe,
      their own ‘dots’, and how they interact with the larger forces at
    ...
    <p>
      ...
      a contrasting hue and holding a heart-shaped balloon. Might this be an
      avatar for the artist? The balloon, an object of whimsy and ascent, might
      suggest the elevation of the artist’s aspirations and the lightness of
      dreams (The Moon) against the gravity of reality (The Dot). Combined, they
      speak of the artist’s love for his practice, a love that is not bound by
    ...
    <p>
      <span>
        ...
        stand-out figure with the balloon was created by means of encapsulating
        the transient nature of a brief romance the artist experienced while
        being on a trip to São Paulo. The piece is set in the thrall of the
        city’s vibrant nightlife and the ephemeral connections it fosters. The
        balloon in the shape of a heart, the latter a symbol of love in its
        myriad forms, here represents the artist’s contemplation of both
        affection and at the same time solitude within the fleeting intimacy of
    ...
    <p>
      ...
      reflection on omentejovem’s journey and an open invitation to the viewer
