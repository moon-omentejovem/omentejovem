...
export function Header() {
  ...
  return (
    <header className="sticky top-0 flex w-full justify-between bg-background z-50 max-w-[1920px] mx-auto md:bg-transparent p-8 md:px-12 lg:px-20 md:py-10 md:gap-16">
      <Link
        href="/"
