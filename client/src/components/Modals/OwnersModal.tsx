    ...
    <Dialog.Root open={open}>
      ...
      <Dialog.Portal>
        <Dialog.Overlay className="modal-overlay fixed inset-0 bg-black/[30%] backdrop-blur-sm z-20">
          ...
          >
            <header className="flex-shrink-0 flex items-center justify-between px-8 py-4 border-b-[1px] border-black bg-background">
            ...
            <div className="flex-1 overflow-y-auto max-h-[90vh] px-8 py-4">
              <ul>
