      ...
      <div className="flex flex-col">
        <p className="font-bold">
          ...
          <a
            target="_blank"
            rel="noreferrer"
            href={`https://${chain === 'ethereum' ? 'etherscan.io/address' : 'tzkt.io'}/${transaction?.from_address}`}
            className="text-primary-50 hover:underline"
          ...
          <a
            target="_blank"
            rel="noreferrer"
            href={`https://${chain === 'ethereum' ? 'etherscan.io/address' : 'tzkt.io'}/${transaction?.to_address}`}
            className="text-primary-50 hover:underline"
