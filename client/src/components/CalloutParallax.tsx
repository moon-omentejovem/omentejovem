...
export function CalloutParallax({ title, subtitle, calloutImages }: CalloutParallaxProperties) {
	...
	const shiftBackground = useCallback((event: MouseEvent): void => {
		if (calloutReference.current) {
			...
			const elements = calloutReference.current.querySelectorAll('div#callout-element')
			const radius = 1000
	...
	return (
		...
		>
			<div className="relative flex flex-col items-center px-12">
				...
				<div id="callout-element" className="parallax-text absolute -top-[10%] z-[2]">
