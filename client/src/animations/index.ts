...
CustomEase.create('custom', 'M0,0 C0,0.421 0.037,0.632 0.116,0.779 0.182,0.902 0.374,1 1,1')
CustomEase.create('custom-out', 'M0,0 C0.299,0 0.594,-0.011 0.772,0.047 1.016,0.127 1,0.949 1,1')
...
export function modalAnimations(setIsAnimating: Dispatch<SetStateAction<boolean>>) {
	setIsAnimating(true)
...
export function carouselFigcaptionAnimation(element: HTMLElement, open: boolean) {
	if (open) {
